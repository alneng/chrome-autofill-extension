...
document.getElementById("tab-select-1").addEventListener("click", constructShippingInfoInputs)
document.getElementById("tab-select-2").addEventListener("click", constructBillingInfoInputs)
document.getElementById("tab-select-3").addEventListener("click", constructSettingsInputs)
